...
function Javasc(){
    return(
     ...
     <div className='text-xl font-bold font-sans pl-7 pt-7'>Grow your software development skills with JavaScript</div>

     <div className='pt-2 pl-7'>JavaScript is a text-based computer programming language used to make dynamic web pages.<br/> A must-learn for aspiring web developers or programmers, JavaScript can be used for  features <br/> like image carousels, displaying countdowns and timers, and playing media on a webpage.  </div>
       
     <input className=' border border-black rounded-sm bg-white font-bold text-sm cursor-pointer hover:bg-yellow-200 h-10 w-44 ml-7 mt-4' type="button" value={'Explore JavaScript'} />  
    ...
    {/* main div for all contents below 1st column of explore html and css*/}
     <div className=' grid flex-col ml-7 gap-1 '>
       ...
       <img className='h-32 w-60 border rounded-sm mt-6 cursor-pointer' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPnP_J3m-gAyw9xMNhempgekkYpVaxaew13w&usqp=CAU" alt="" />
